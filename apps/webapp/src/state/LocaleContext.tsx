...
const dictionaries = {
  ru: {
    ...
    account: {
        ...
        onboardingCopy: 'Подключи аккаунт, чтобы лайки и коллекции были одинаковыми в вебе и Telegram.',
        signInAndSync: 'Войти и синхронизировать',
        localProfile: 'Локальный профиль',
        connected: 'В облаке',
        connectedAs: 'Подключено как',
        local: 'Локально',
        connectedCopy: 'Профиль подключен. Лайки и история уже синхронизируются между устройствами.',
        telegramCopy: 'Открой Mini App в Telegram, и избранное останется с тобой на других устройствах.',
        guestCopy: 'Сейчас это локальный режим. Войди, чтобы синхронизировать лайки и коллекции.',
        manage: 'Управлять',
  ...
  en: {
    ...
    home: {
      ...
      account: {
          ...
          onboardingCopy: 'Connect an account to keep favorites and collections the same in web and Telegram.',
          signInAndSync: 'Sign in and sync',
          localProfile: 'Local profile',
          connected: 'Cloud',
          connectedAs: 'Connected as',
          local: 'Local',
          connectedCopy: 'Profile connected. Favorites and history now sync across devices.',
          telegramCopy: 'Open the Mini App in Telegram and your favorites will stay with you on other devices.',
          guestCopy: 'You are in local mode right now. Sign in to sync favorites and collections.',
          manage: 'Manage',
