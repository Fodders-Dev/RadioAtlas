  ...
  ru: {
    ...
    home: {
      ...
      quickMix: 'Быстрый микс',
        ...
        countryFallbackCopyCompact: 'Открой глобус и выбери страну на карте.',
    ...
    account: {
        ...
        sheetKicker: 'Профиль',
        sheetTitle: 'Аккаунт',
        sheetSubtitle: 'Один профиль для всех устройств.',
        sheetGuestTitle: 'Гостевой режим',
        sheetGuestCopy: 'Сейчас всё хранится только на этом устройстве.',
        onboardingTitle: 'Войти и синхронизировать',
        onboardingCopy: 'Синхронизируй лайки и коллекции между вебом и Telegram.',
        ...
        local: 'Локально',
        connectedCopy: 'Лайки и история уже в облаке.',
        telegramCopy: 'Войди через Telegram и продолжай на любом устройстве.',
        guestCopy: 'Войди, чтобы синхронизировать лайки и коллекции.',
        manage: 'Управлять',
    ...
    radio: {
      ...
      discoverResults: 'Результаты подборок',
  ...
  en: {
    ...
    home: {
        ...
        quickMix: 'Quick mix',
          ...
          countryFallbackCopyCompact: 'Open the globe and pick a country.',
      ...
      account: {
          ...
          sheetKicker: 'Profile',
          sheetTitle: 'Account',
          sheetSubtitle: 'One profile across devices.',
          sheetGuestTitle: 'Guest mode',
          sheetGuestCopy: 'Everything is stored only on this device right now.',
          onboardingTitle: 'Sign in and sync',
          onboardingCopy: 'Sync favorites and collections across web and Telegram.',
          ...
          local: 'Local',
          connectedCopy: 'Favorites and history are already in sync.',
          telegramCopy: 'Sign in with Telegram and continue on any device.',
          guestCopy: 'Sign in to sync favorites and collections.',
          manage: 'Manage',
