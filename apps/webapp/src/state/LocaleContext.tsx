...
const dictionaries = {
  ru: {
    ...
    home: {
      ...
      freshSignalsTitle: 'Новый заход',
      freshSignalsCopy: 'Четыре свежих станции, которые меняются вместе с витриной.',
      ...
      genreSpotlightCopy: 'Быстрый вход в настроение с живыми станциями вместо бесконечного каталога.',
  ...
  en: {
    ...
    home: {
      ...
      freshSignalsTitle: 'Fresh entry',
      freshSignalsCopy: 'Four live stations that rotate with the front page.',
      ...
      genreSpotlightCopy: 'A quick way into a mood without dumping the whole catalog on people.',
