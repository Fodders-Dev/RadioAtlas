...
const dictionaries = {
  ru: {
    ...
    account: {
        ...
        onboardingCopy: 'Подключи профиль и держи лайки, недавнее и коллекции одинаковыми на всех устройствах.',
  ...
  en: {
    ...
    home: {
      ...
      account: {
          ...
          onboardingCopy: 'Connect a profile and keep favorites, recents, and collections the same on every device.',
