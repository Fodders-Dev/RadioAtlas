...
export const ruDictionary = {
  calm: {
    ...
    "moreDirection": "Копнуть глубже",
      ...
      "pixels": {
        ...
        "copy": "Загляни в чиптюн: начни с этого эфира."
      },
      "jazz": {
        "eyebrow": "JAZZ",
        "title": "Пусть свернёт не туда",
        "copy": "Одна джазовая станция для начала. Остальное — в эфире."
      },
      "ambient": {
        "eyebrow": "AMBIENT / DOWNTEMPO",
        "title": "Меньше спешки",
        "copy": "Попробуй станции с эмбиентом и даунтемпо."
      },
      "electronic": {
        "eyebrow": "ELECTRONIC",
        "title": "Поймать другой ритм",
        "copy": "Электронная музыка из другого источника."
      },
      "folk": {
        "eyebrow": "FOLK / WORLD",
        "title": "За пределами знакомого",
        "copy": "Фолк и музыка мира. Начни с одной станции."
      },
      "classical": {
        "eyebrow": "CLASSICAL",
        "title": "Сменить масштаб",
        "copy": "Классическая музыка в живом эфире."
      },
      "pop": {
        "eyebrow": "POP",
        "title": "Поп с другого берега",
        "copy": "Знакомый жанр, другой источник. Прислушайся."
      }
    },
    kicker: 'РАДИО, КОТОРОЕ УДИВЛЯЕТ', title: 'Открой свой эфир', offer: 'ТОЧКА СТАРТА',
    start: 'Включить эфир', listening: 'Открыть плеер', choose: 'Листать эфиры', moods: 'Под настроение',
    chooseSub: 'Вдруг зацепит', globe: 'На глобусе', world: 'Что звучит в мире', country: 'Выбрать страну',
    source: 'Вернуться на станцию', openFinds: 'Разобрать находки', openFindsSub: 'Открыть треки в своём сервисе',
    night: 'Ночная езда', nightSub: 'Синтвейв, ретровейв', slow: 'Помедленнее', slowSub: 'Эмбиент', jazz: 'В ритме джаза', jazzSub: 'Джаз',
    moreAir: 'Ещё один хороший эфир', finds: 'Твои находки', keep: 'Хорошее не потеряется', keepSub: 'Услышишь своё — нажми закладку',
    player: 'Плеер', save: 'Сохранить трек', saved: 'Трек в находках', paused: 'На паузе', error: 'Не удалось подключиться'
  },
  ...
  mapExplorer: {
    ...
    listLabel: 'Станции в выбранной области', showOnMap: 'Показать {name} на карте', play: 'Включить {name}', more: 'Ещё эфиры',
    empty: 'В этой области ничего не найдено.', pickCountry: 'Выбрать страну', searchCatalog: 'Искать в каталоге',
    count: { one: '{count} эфир', few: '{count} эфира', many: '{count} эфиров', other: '{count} эфира' },
    panelLabel: 'Станции на карте', backToList: 'Эфиры', lira: 'Лира', askLira: 'Спросить Лиру об источнике',
    favorite: 'Любимая станция', unfavorite: 'Убрать из любимых', details: 'Подробнее об источнике', hideDetails: 'Свернуть подробности',
    listening: 'слушаем', connecting: 'подключаем', selected: 'Выбранный источник',
    heartNote: 'Сердце сохраняет сам источник. Закладка ловит трек, если станция передаёт его название.',
  ...
  journal: {
    ...
    nowOnAir: 'Сейчас в эфире', nowOffer: 'Готово к запуску', nowPaused: 'На паузе', entryFeed: 'Лента', entryFeedCopy: 'свайп — другой эфир', entryGlobe: 'Глобус', entryGlobeCopy: 'точки настоящих мест', entryGlobeWord: 'мир', doorsLabel: 'Куда дальше', dirFeed: 'Лента', dirFeedCopy: 'листать эфиры', dirGlobe: 'Глобус', dirGlobeCopy: 'станции на карте', dirMoods: 'Настроение', dirMoodsCopy: 'подборки', dirCountries: 'Страны', dirCountriesCopy: 'по местам', dirGenres: 'Жанры', dirGenresCopy: 'по звучанию', dirMine: 'Моё', dirMineCopy: 'избранное и находки', liveTitle: 'Эфиры сейчас', liveAll: 'Все', liveFavorites: 'Избранное', liveRecent: 'Недавние', liveMore: 'Ещё эфиров', liveCatalog: 'Весь каталог', liveCount: 'Показано {shown} из {total}', queueContext: 'Моя очередь', queueDiscoverySource: 'Новые эфиры', feedDeck: 'Дальше в Ленте', queueEnd: 'Очередь закончилась', railStation: 'Станция', railTrack: 'Трек', railVolume: 'Звук', railLira: 'Лира', railMore: 'Ещё', queueContinue: 'Открывать новое', queueTab: '{label} · {index} из {total}', discoverTab: 'Открывать новое',
    ...
    feedHint: 'Вверх — следующий эфир', feedVolume: 'Управление эфиром', feedLiveMusic: 'Музыка в прямом эфире', feedFilters: 'Какие эфиры показывать',
    sceneWords: { pop: 'поп.', rock: 'рок.', electronic: 'электро.', jazz: 'джаз.', classical: 'классика.', chill: 'тихо.', hiphop: 'ритм.', world: 'мир.', talk: 'слово.', unknown: 'эфир.' }, timerCopy: 'Эфир остановится сам, а станция останется в мини-плеере.', timerRunning: 'Осталось {left} — потом эфир остановится сам.', timerCustom: 'Свои минуты', timerStart: 'Запустить',
    liraGuide: 'Ваш музыкальный проводник', liraHelp: 'Что умеет Лира', liraHelpTitle: 'Привет, я Лира — музыкальный проводник.', liraHelpCopy: 'Найду станцию по жанру, стране или настроению, расскажу, что за песня играет, предложу похожее и покажу источник на глобусе. Отвечаю по каталогу RadioAtlas и тому, что станция передаёт сама.', liraHelpNote: 'Если данных о станции нет, я так и скажу — придумывать не стану.', liraAsk: 'Что послушаем?', liraOpening: 'Джаз без спешки, что-то из Токио или «удиви меня» — с чего начнём?', liraOpenFirst: 'Можно начать с {name}', liraOpenSecond: 'Или свернуть к {name}', liraOpenGenre: ' — там {genre}', liraOpenAsk: 'Какой поворот выбираем?', liraOpenAskOne: 'Или спросите о своём.', liraOnAir: 'Сейчас в эфире', liraPicks: 'Из каталога сегодня', mapTitle: 'Музыка на карте', mapAll: 'Глобус', mapHint: 'Коснитесь страны — и окажитесь среди её эфиров.',
    ...
    stories: {
      jazz: { kicker: 'ЖАНР · ДЖАЗ', title: 'Откройте джаз', copy: 'Эфиры с тегом «джаз»: от камерного трио до свободного грува.', poster: 'джаз' },
      night: { kicker: 'ПОЗДНИЙ ВЕЧЕР', title: 'Тихая музыка на ночь', copy: 'Чиллаут, эмбиент, лаунж и медленный джаз — эфиры, которые не мешают засыпать.', poster: 'на\nночь' },
      groove: { kicker: 'ЖАНР · ФАНК И СОУЛ', title: 'Фанк и соул', copy: 'Эфиры с тегом «фанк»: соул, диско и басовые линии, под которые трудно сидеть.', poster: 'фанк' },
      world: { kicker: 'ЖАНР · МУЗЫКА МИРА', title: 'Музыка мира', copy: 'Эфиры с тегом «world music»: другой язык, другой ритм, новая точка на карте.', poster: 'мир' },
      road: { kicker: 'В ДОРОГУ', title: 'Рок и хиты в дорогу', copy: 'Рок, классические хиты и топ-40 — ровный ритм для долгой дороги.', poster: 'в\nдорогу' },
      focus: { kicker: 'ДЛЯ РАБОТЫ', title: 'Фон для работы', copy: 'Классика, инструментал, лоу-фай и фортепиано — музыка, которая не отвлекает.', poster: 'фокус' },
      workout: { kicker: 'ТРЕНИРОВКА', title: 'Энергия для тренировки', copy: 'Электроника, хаус и EDM — эфиры, под которые хочется двигаться.', poster: 'темп' }
    }
  },
  "errorBoundary": {
  ...
  "feed": {
    ...
    "recordHint": "Длительность выберете в Telegram. Файл придёт в чат с ботом.",
  ...
  "home": {
    ...
    "seeAll": "Смотреть все",
    "heroClockNow": "сейчас {time}",
    "firstRunTitle": "Это живой эфир, а не плейлист",
    "firstRunBody": "Где-то прямо сейчас идёт передача — включи и окажешься там. Сохранишь станцию, и она останется здесь.",
    "firstRunBrowse": "Смотреть все станции",
    "quickChipsLabel": "Быстрый выбор",
    "chipTrending": "Хиты",
    "chipNight": "Вечер",
    "chipWorkout": "Спорт",
    "chipDriving": "В дорогу",
    "chipFocus": "Фокус",
    "chipNews": "Новости",
    "newStationsTitle": "Новые станции",
    "newStationsCopy": "Каждый раз новые — из глубины каталога.",
    ...
    "feedEntrySub": "Станции одна за другой",
    ...
    "genreMetal": "Метал",
    "genreAmbient": "Эмбиент",
    "openLibrary": "Открыть медиатеку",
    "refreshFeed": "Обновить",
    ...
    "freshSignalsCopy": "Подборка на сейчас.",
    "freshSignalsCopyCompact": "Подборка на сейчас.",
  ...
  "account": {
    ...
    "delete": {
      ...
      "subtitle": "Сохранённые станции, коллекции, привязанные входы и история покупок будут стёрты с сервера. Это нельзя отменить.",
      "action": "Удалить аккаунт",
      "confirm": "Удалить аккаунт и все сохранённые станции? Восстановить не получится.",
      "confirmAction": "Да, удалить",
      "busy": "Удаляем…"
    },
  ...
  "globe": {
    ...
    "tapToPlayHint": "Наведи точку к центру и тапни — включится станция",
    "aimTapCta": "Тапни, чтобы включить",
  ...
  "search": {
    ...
    "resultsShown": "Показано {shown} из {total}",
    ...
    "genresTitle": "Жанры",
    "languagesTitle": "Язык",
    "resultsFound": "Найдено станций: {total}",
    ...
    "sortCountry": "По стране",
    "liveNow": "LIVE",
    "removeRecentQuery": "Убрать из истории",
  ...
  "library": {
    ...
    "removeStationFromCollection": "Убрать {station} из плейлиста",
    ...
    "searchNoResults": "Ничего не найдено по запросу «{query}»",
    "searchEmptyLibrary": "Медиатека пока пуста — добавь станции в избранное, плейлисты или подписки.",
    "searchInCatalog": "Искать в каталоге",
    "searchResultFromFavorites": "Избранное",
    "searchResultFromRecent": "Недавнее",
    "searchResultFromCollection": "Коллекция · {name}",
    "searchResultFromFollowed": "Подписка",
    "shuffleQueue": "Перемешать следующие",
    "shuffleQueueAria": "Перемешать следующие станции очереди",
    "shuffleQueueAnnounce": "Следующие станции перемешаны",
    ...
    "sortRecent": "Свежие",
    "sortName": "По имени",
    "collectionsEmptyTitle": "Плейлистов пока нет",
    "collectionsEmptyCopy": "Создай первый плейлист для любимых сетов, стран или настроений.",
  ...
  "dock": {
    ...
    "copyCurrentTrack": "Сохранить находку",
    "currentTrackUnavailable": "Название трека пока недоступно",
    "liveBroadcast": "Прямой эфир",
    "stationSendsNoTitles": "Эта станция не передаёт названия треков",
  ...
  "settings": {
    ...
    "clearCacheConfirm": "Очистить кэш каталога и глобуса?",
    ...
    "clearRecentConfirm": "Очистить недавние станции? Сейчас сохранено: {count}.",
    "privacyLabel": "Политика конфиденциальности",
    "privacyDesc": "Какие данные собираются, кому передаются и как их удалить.",
    "privacyOpen": "Открыть",
    "confirmClear": "Да, очистить",
    "sleepTitle": "Сон и звук",
  ...
  "theme": {
    ...
    "sectionNavLabel": "Разделы редактора",
    "collapsePreview": "Свернуть превью",
    "expandPreview": "Развернуть превью",
    "editGradient": "Настроить градиент",
    "openDecor": "Стикер, GIF и эмодзи",
  ...
  "genre": {
    ...
    "seventies": "Семидесятые",
    "eighties": "Восьмидесятые",
    "nineties": "Девяностые",
    "twoThousands": "Двухтысячные",
    "country": "Кантри",
    "folk": "Фолк",
    "bluegrass": "Блюграсс",
    "world": "Музыка мира",
    ...
    "children": "Детское",
    "easyListening": "Спокойная музыка",
    "adultContemporary": "Взрослая современная",
  ...
  "chat": {
    "launch": "Лира",
    "launchHint": "Поговорить о музыке",
    "kicker": "Музыкальная спутница",
    "title": "Лира",
    "status": "на связи",
    "threadSaved": "единый чат · сохранён",
    "newChat": "Очистить чат",
    "clearChatConfirm": "Очистить всю переписку с Лирой на этом устройстве?",
    "welcomeTitle": "Привет! Я Лира.",
    "greeting": "Расскажи, какое у тебя сегодня настроение. Я найду музыку, разберу песню или устрою маленькое путешествие по мировому эфиру.",
    "quickPrompts": "Быстрые вопросы Лире",
    "promptNight": "Что послушать для ночной работы",
    "promptNightQuery": "Что послушать для ночной работы? Найди спокойное радио без резких переходов",
    "promptThisStation": "Что за станция?",
    ...
    "promptMorningQuery": "Что послушать с утра, чтобы спокойно раскачаться?",
    "promptEvening": "На вечер",
    "promptEveningQuery": "Посоветуй что-нибудь на вечер, когда день уже позади",
    "promptFocus": "Для работы",
    "promptFocusQuery": "Нужен ровный фон для работы — без слов и без сюрпризов",
    "promptRoad": "В дорогу",
    "promptRoadQuery": "Что поставить в долгую дорогу?",
    "promptFaraway": "Подальше отсюда",
    "promptFarawayQuery": "Дай станцию из страны, о которой я бы сам не подумал",
    "promptSurprise": "Удиви меня",
    "promptSurpriseQuery": "Покажи что-нибудь неожиданное, чего я точно ещё не слышал",
    "promptRetro": "Из прошлого",
    "promptRetroQuery": "Хочу что-нибудь из восьмидесятых или девяностых",
    "promptLofi": "Радио в стиле lofi и chill",
    "promptLofiQuery": "Найди уютное радио в стиле lofi и chill",
    "promptTokyo": "Станции из Токио",
    "promptTokyoQuery": "Покажи интересные станции из Токио",
    "promptEnergy": "Энергичный электро-микс",
    "promptEnergyQuery": "Включи энергичный электро-микс, чтобы встряхнуться",
    "historyHint": "У Лиры один постоянный чат. Закрой его и вернись через кнопку «Лира» — переписка останется на этом устройстве.",
    "placeholder": "Напиши Лире о музыке…",
    "send": "Отправить",
    "thinking": "Лира печатает…",
    "error": "Ой, связь на секунду подвисла. Попробуй ещё разок.",
    "actionFailed": "Действие не выполнилось — состояние плеера не изменено.",
    "actionPlayed": "Станция включена",
    "actionPaused": "Поставлено на паузу",
    "actionQueued": "Добавлено в очередь",
    "actionFavoriteUpdated": "Избранное обновлено",
    "actionAlreadyQueued": "Уже было в очереди",
    "actionAlreadyDone": "Уже было сделано",
    "sourceLabel": "Лира",
    "sources": "Источники",
    "source": "Источник",
    ...
    "moreServices": "Ещё сервисы ({count})",
