...
export const ruDictionary = {
  ...
  "chat": {
    ...
    "historyHint": "Этот диалог сохраняется только на твоём устройстве.",
    "currentTrack": "Сейчас в эфире · спросить Лиру",
    "currentTrackQuery": "Прочитай текст этой песни, объясни, о чём она, дай короткий отрывок и ссылку на полный текст",
