...
export const ruDictionary = {
  ...
  journal: {
    ...
    nowOnAir: 'Сейчас в эфире', nowOffer: 'Готово к запуску', nowPaused: 'На паузе', entryFeed: 'Лента', entryFeedCopy: 'свайп — другой эфир', entryGlobe: 'Глобус', entryGlobeCopy: 'точки настоящих мест', liveTitle: 'Эфиры сейчас', liveAll: 'Все', liveFavorites: 'Избранное', liveRecent: 'Недавние', liveMore: 'Ещё эфиров', liveCatalog: 'Весь каталог', liveCount: 'Показано {shown} из {total}', queueContext: 'Моя очередь', queueEnd: 'Очередь закончилась', queueContinue: 'Открывать новое', queueTab: '{label} · {index} из {total}', discoverTab: 'Открывать новое',
