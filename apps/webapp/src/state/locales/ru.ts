...
export const ruDictionary = {
  calm: {
    kicker: 'РАДИО, КОТОРОЕ УДИВЛЯЕТ', title: 'Что услышим сегодня?', offer: 'СЕГОДНЯ ПОПРОБУЙ',
    start: 'Включить эфир', listening: 'Открыть плеер', choose: 'Подобрать другое', moods: 'Под настроение',
