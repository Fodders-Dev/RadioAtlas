...
export const enDictionary = {
  ...
  journal: {
    ...
    nowOnAir: 'On air now', nowOffer: 'Ready to play', nowPaused: 'Paused', entryFeed: 'Feed', entryFeedCopy: 'swipe for another station', entryGlobe: 'Globe', entryGlobeCopy: 'dots of real places', liveTitle: 'On air now', liveAll: 'All', liveFavorites: 'Favourites', liveRecent: 'Recent', liveMore: 'More stations', liveCatalog: 'Whole catalogue', liveCount: 'Showing {shown} of {total}', queueContext: 'My queue', queueEnd: 'End of the queue', queueContinue: 'Discover new', queueTab: '{label} · {index} of {total}', discoverTab: 'Discover new',
