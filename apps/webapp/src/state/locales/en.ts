...
export const enDictionary = {
  ...
  "chat": {
    ...
    "historyHint": "This conversation is stored only on your device.",
    "currentTrack": "On air now · ask Lira",
    "currentTrackQuery": "Read the lyrics to this song, explain what it means, share one short excerpt, and link the full lyrics",
