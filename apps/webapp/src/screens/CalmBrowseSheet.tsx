...
export function CalmBrowseSheet({ title, kicker, copy, art, query, picks, cache, source, onPlay, onSource, onClose }: {
  title: string; kicker?: string; copy?: string; art?: PosterArt;
