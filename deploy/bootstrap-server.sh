...
STATION_INTEL_DB_PATH="${STATION_INTEL_DB_PATH:-$SHARED_DATA_DIR/station-intelligence.sqlite}"
...
upsert_env "$SHARED_ENV_DIR/api.env" "STATION_INTEL_DB_PATH" "$STATION_INTEL_DB_PATH"
